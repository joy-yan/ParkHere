...
public class LoginActivity extends BaseActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setUpGoogleButton(buttonGoogleSignIn);
    ...
    private void setUpGoogleButton(View view) {
        view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                //Utils.showToast(LoginActivity.this, "google button");
                signInWithGoogle();
            }
        });
    }
        ...
        mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        // [START_EXCLUDE]
                        if (!task.isSuccessful()) {
                            Utils.showToast(LoginActivity.this, getString(R.string.auth_failed));
                        }
                        hideProgressDialog();
                        // [END_EXCLUDE]
                    }
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (null != user) {
            ...
            Utils.putPref(Constants.EXTRA_KEY_USER_UID, user.getUid(), LoginActivity.this);
            gotoMainActivity();
        }
    }
...
////            Utils.showToast(LoginActivity.this, "clicked");
////            signInWithGoogle();
////
////        }
//    }
